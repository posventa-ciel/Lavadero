...
# --- 2. ESTILOS CSS (TU DISEÑO ULTRA COMPACTO) ---
st.markdown("""
<style>
...
def main():
    ...
    # ÍNDICES SEGÚN TU IMAGEN: HORA PROM=8, INI=9, FIN=10, INI2=11, FIN2=12, ESTADO=13, CONTROL=14
    IDX_FECHA, IDX_ASE, IDX_DOM, IDX_MOD = 0, 2, 3, 4
    IDX_PRO, IDX_INI1, IDX_FIN1, IDX_INI2, IDX_FIN2, IDX_EST, IDX_CTRL = 8, 9, 10, 11, 12, 13, 14
    ...
    for i, fila in enumerate(raw_data[1:], start=2):
        ...
        # CLAVE: Solo se va de la lista si el estado es FINALIZADO
        ...
        item = {
            ...
            "tiempo": calcular_minutos_totales(fila[IDX_INI1], fila[IDX_FIN1], fila[IDX_INI2], fila[IDX_FIN2]),
            "fecha": f_celda
        }
        ...
        if es_finalizado:
            ...
            try:
                m_num = datetime.strptime(f_celda.split()[0], "%d/%m/%Y").month
                meses = ["Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"]
                if meses[m_num-1] == mes_historial: historico_mes.append(item)
            except: pass
        else:
