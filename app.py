...
def main():
    ...
    for i, fila in enumerate(raw_data[1:], start=2):
        ...
        # --- CANDADO 1: Si no tiene Patente ni Cliente, es fila vacía ---
        if not dom_raw and not cli_raw: continue
        ...
        tiene_fin = (fila[IDX_FIN1].strip() != "" or fila[IDX_FIN2].strip() != "") and estado == "FINALIZADO"
        ...
        # --- CANDADO 2: LÓGICA LAVADERO (Excluye NO SE LAVA/NO VINO) ---
        ...
        # --- CANDADO 3: LÓGICA TALLER (Solo si tiene hora recepción) ---
